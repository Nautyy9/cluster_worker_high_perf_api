...
import { dataFromFileType, postRequestType } from "../../type.js"
        ...
        process.on("message", async (msg: postRequestType) => {
          ...
          if (msg.type === "insider_worker_comm") {
            ...
            if (data) {
              ...
              saveData(
                new Set([{ from: msg.from, to: msg.to, message: msg.message }])
              )
            }
          }
        })
