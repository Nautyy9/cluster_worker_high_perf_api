...
export function createHttpRequest(msg, requestCount) {
...
function http_request(content) {
    const { body, headers, hostname, method, options, type, requestCount, workerId, } = content;
    // console.log(content)
